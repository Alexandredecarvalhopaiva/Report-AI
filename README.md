...
- Logo original recebida: `assets/ms-logo-original.png`
- Logo horizontal usada no site: `assets/ms-logo-wide.png`
- Monograma usado no painel/favicon: `assets/ms-logo-mark.png`
- Imagem hero gerada por IA: `assets/hero-ms-cleaning-team.png`

## Paleta da marca

- Azul-petróleo principal: `#006783`
- Ciano MS: `#16A9D2`
- Cinza da assinatura: `#6E7073`
- Fundo claro: `#F7FBFD`
- Grafite de apoio: `#132B36`
...
Os dados são fictícios e ficam salvos no `localStorage` do navegador.
